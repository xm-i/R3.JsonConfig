...
public class Program {
	public static void Main(string[] args) {
		...
		var options = new JsonSerializerOptions(ConfigJsonSerializerContext.Default.Options) {
			TypeInfoResolver = ConfigJsonSerializerContext.Default.WithAddedModifier(global::GenJsonConfig.ForJsonConverterRegistry.ApplyPolymorphism)
		};
