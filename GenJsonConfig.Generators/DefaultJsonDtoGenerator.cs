...
public partial class {modelSymbol.Name}ForJson {{
	...
	/// 基底では常に例外をスローする。
	/// </summary>
	protected virtual {modelFullName} CreateModelCore(global::System.IServiceProvider sp, global::GenJsonConfig.ReferenceResolver resolver) {{
	...
	public static {modelFullName}? CreateModel({dtoFullName}? json, global::System.IServiceProvider sp, global::GenJsonConfig.ReferenceResolver? resolver = null) {{
		...
		resolver ??= new global::GenJsonConfig.ReferenceResolver();
	...
	public static {dtoFullName}? CreateJson({modelFullName}? model, global::GenJsonConfig.ReferenceTracker? tracker = null) {{
		if (model is null) return null;
		tracker ??= new global::GenJsonConfig.ReferenceTracker();
		return global::GenJsonConfig.ForJsonConverterRegistry.CreateJson<{modelFullName}, {dtoFullName}>(model, tracker);
	}}
}}";
	}
	...
	private string BuildConcreteDto(
		...
		sb.AppendLine($"\tpublic static {dtoFullName}? CreateJson({modelFullName}? model, global::GenJsonConfig.ReferenceTracker? tracker = null) {{");
		sb.AppendLine("\t\tif (model is null) {");
		sb.AppendLine("\t\t\treturn null;");
		sb.AppendLine("\t\t}");
		sb.AppendLine("\t\ttracker ??= new global::GenJsonConfig.ReferenceTracker();");
...
$@"	/// <summary>基底型の CreateModelCore をオーバーライドし、この型のモデルを復元する。</summary>
	{visibility} {resolveBaseTypeFqn} {resolveMethod}(global::System.IServiceProvider sp, global::GenJsonConfig.ReferenceResolver resolver) {{
		var json = this;
";
		}
	}
...
internal static partial class {modelSymbol.Name}ForJsonRuntimeRegistration {{
	...
	public static void Register() {{
		global::GenJsonConfig.ForJsonConverterRegistry.Register<
			{baseTypeFullName},
